# ==============================================================================
# ⚠️ NOTA DE ARQUITETURA / ARCHITECTURAL NOTE
# Este script utilitário foi projetado para rodar no diretório raiz do projeto 
# "photo_organizer" que contém os módulos de persistência e detecção na pasta `src/`.
# Caso execute fora desse contexto local, certifique-se de importar ou clonar
# a estrutura correspondente e ajustar as dependências do Python.
#
# This utility script is designed to run within the root directory of the
# "photo_organizer" project containing the persistence and detection modules in the `src/` folder.
# If running outside of this local context, make sure to import or clone
# the corresponding structure and adjust Python dependencies accordingly.
# ==============================================================================
...
_root = _Path(__file__).resolve().parent.parent.parent # Ajustado para subir até a raiz do projeto / Adjusted to reach project root
