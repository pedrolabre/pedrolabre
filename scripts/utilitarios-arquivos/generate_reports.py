...
# "photo_organizer" que contém os módulos de persistência e utilitários na pasta `src/`.
...
# "photo_organizer" project containing the persistence and utility modules in the `src/` folder.
...
_root = Path(__file__).resolve().parent.parent.parent # Ajustado para subir até a raiz do projeto / Adjusted to reach project root
